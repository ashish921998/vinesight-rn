              ...
              <View className="ml-3">
                ...
                {hasCoordinates && (
                  <Text className="text-xs text-surface-500">
                    {selectedFarm?.latitude?.toFixed(4)},{" "}
                    {selectedFarm?.longitude?.toFixed(4)}
                  </Text>
                )}
              </View>
            </View>
        ...
        {!hasCoordinates && (
          <View className="bg-amber-50 rounded-xl p-4 mb-4 flex-row items-start">
            ...
            <Text className="text-amber-800 text-sm ml-3 flex-1">
              This farm doesn't have location coordinates. Weather data is
              showing default location (Nashik). Add GPS coordinates to get
        ...
        {etc && (
          <View className="bg-white rounded-2xl p-4 mb-4">
            ...
            <View className="flex-row flex-wrap" style={{ gap: 12 }}>
              <View
                className="bg-surface-50 rounded-xl p-3 flex-1"
                style={{ minWidth: "45%" }}
              >
              ...
              {irrigationSchedule && (
                <View
                  className="bg-blue-50 rounded-xl p-3 flex-1"
                  style={{ minWidth: "45%" }}
                >
            ...
            <View className="bg-white rounded-2xl p-4 mb-3">
              <View className="flex-row items-center justify-between mb-2">
                ...
                <View
                  ...
                  style={{
                    backgroundColor:
                      urgencyColors[alerts.irrigation.urgency].bg,
                  }}
                >
                  <Text
              ...
              {alerts.irrigation.recommendations.map((rec, i) => (
                <View key={i} className="flex-row items-start mt-2">
                  ...
                  <Text className="text-xs text-surface-600 ml-2 flex-1">
                    {rec}
                  </Text>
                </View>
              ))}
              ...
              <View className="flex-row items-center justify-between mb-2">
                ...
                >
                  <Text
                    className="text-xs font-medium"
                    style={{
                      color: alerts.harvest.isOptimal ? "#166534" : "#92400E",
                    }}
                  >
