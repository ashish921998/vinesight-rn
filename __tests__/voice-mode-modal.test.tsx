  ...
  useTranslation: () => ({
    t: (key: string) => {
      const map: Record<string, string> = {
        ...
        'assistant.chat.voiceMode': 'Voice mode',
        'assistant.chat.tapToSpeak': 'Tap to speak',
        'assistant.chat.thinking': 'Thinking...',
        'assistant.chat.assistantSpeaking': 'Assistant is speaking...',
        'assistant.chat.transcriptPlaceholder': 'Your speech will appear here...',
