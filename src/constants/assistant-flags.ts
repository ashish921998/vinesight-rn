...
export const assistantModelConfig = {
  advisoryModel: process.env.EXPO_PUBLIC_ASSISTANT_MODEL?.trim() || 'sarvam-105b',
  extractionModel: process.env.EXPO_PUBLIC_ASSISTANT_EXTRACTION_MODEL?.trim() || 'sarvam-105b',
};
