...
export function GuidedTourCompletionCard({ onDone }: { onDone: () => void }) {
  ...
  const haloOpacity = pulse.interpolate({ inputRange: [0, 1], outputRange: [0.34, 0.12] });
  ...
  return (
    <View style={StyleSheet.absoluteFill} pointerEvents="auto">
      <LinearGradient
        ...
        colors={[
          colorWithOpacity('#0A1208', 0.78),
          colorWithOpacity(m3.colorScheme.primary, 0.38),
          colorWithOpacity('#000000', 0.7),
        ]}
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
      />
        ...
        >
          <LinearGradient
            ...
            colors={[
              ...
              colorWithOpacity(m3.colorScheme.secondary, 0.18),
              'transparent',
            ]}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
          ...
          <View style={{ alignItems: 'center', marginBottom: spacing[5] }}>
            ...
            >
              <UiSymbol name="sparkles" size={34} color={m3.colorScheme.primary} />
            </View>
          </View>
