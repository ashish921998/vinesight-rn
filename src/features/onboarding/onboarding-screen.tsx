...
export function OnboardingScreen() {
  ...
  const handleFarmResolved = useCallback((farmId: number | null) => {
    ...
    // Prevent two modal gates from firing for a fresh farmer landing on /(tabs):
    // the guided-tour welcome card (shown whenever status==='not_started') and
    // the Simplified-mode intro modal (shown until hasSeenSimplifiedModeIntro).
    // New farmers have already been taught the farm+log flow in onboarding.
