...
export const mr = {
  ...
  settings: {
    ...
    deleteAccountModal: {
      ...
      phoneOtpHint: 'आम्ही तुमच्या पडताळलेल्या मोबाइल नंबरवर OTP पाठवू: {{phone}}',
      phoneOtp: {
        label: 'मोबाइल OTP',
        placeholder: '6-अंकी कोड टाका',
        resend: 'मोबाइल OTP पुन्हा पाठवा',
      },
      emailOtp: {
        label: 'ईमेल OTP',
        placeholder: '6-अंकी कोड टाका',
        resend: 'ईमेल OTP पुन्हा पाठवा',
      },
      checkbox: {
      ...
      otpSentTitle: 'पडताळणी कोड पाठवले गेले',
      otpSentBodyPhone: 'पडताळणी कोड तुमच्या मोबाइल नंबरवर पाठवला आहे.',
      otpSentBodyBoth: 'पडताळणी कोड तुमच्या मोबाइल नंबर आणि ईमेलवर पाठवले आहेत.',
      otpResentTitle: 'पडताळणी कोड पुन्हा पाठवला',
      ...
      errors: {
        ...
        phoneRequired: 'खाते हटवण्यापूर्वी कृपया तुमचा मोबाइल नंबर लिंक आणि पडताळा.',
        missingPhoneOtp: 'कृपया मोबाइल OTP टाका.',
        missingEmailOtp: 'कृपया ईमेल OTP टाका.',
        otpSendFailed: 'OTP पाठवता आला नाही. कृपया पुन्हा प्रयत्न करा.',
