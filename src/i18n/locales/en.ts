...
export const en = {
  ...
  farmDetails: {
    ...
    fertilizerPlan: {
      ...
      upcoming: 'Upcoming',
      earlier: 'Earlier',
      noteFromConsultant: 'Note from your consultant',
  ...
  fertigationForm: {
    ...
    fertilizers: {
      ...
      areaEcho: {
        ...
        toPerAcre: '{{quantity}} {{unit}} → {{rate}}/acre',
      },
      doseGuard: {
        highPlan: 'Check quantity — about {{ratio}}× your plan dose ({{reference}})',
  ...
  profileCompletion: {
    ...
    consultantCodeLabel: 'Consultant code (optional)',
    consultantCodePlaceholder: 'e.g. acme-agro',
  ...
  settings: {
    ...
    joinOrg: {
      title: 'Join your consultant',
      rowSubtitle: 'Enter code',
      rowA11y: 'Join your consultant',
      codeLabel: 'Consultant code',
      codePlaceholder: 'e.g. acme-agro',
      helper:
        "Enter the code your consultant gave you. It's the short word they shared (e.g. in a WhatsApp group).",
      joining: 'Joining…',
      join: 'Join',
      successLinked: 'Linked to {{name}}.',
      status: {
  ...
  reports: {
    ...
    lenses: {
      ...
      otherTitle: 'Other (unit not recognized — shown as logged)',
      concentrationOnlyTitle: 'Concentration-only (water volume not logged)',
      rateOnlyTitle: 'Rate-only (farm area unavailable)',
      total: 'Total',
      perAcre: 'Per acre',
      ...
      complianceNote:
        'Verified = applied records logged from this plan item. Approximate = matched by product name only — never presented as verified.',
      waterCoverage:
