...
export const en = {
  ...
  settings: {
    ...
    deleteAccountModal: {
      ...
      phoneOtpHint: 'We will send a one-time code to your verified mobile number: {{phone}}',
      phoneOtp: {
        label: 'Mobile OTP',
      ...
      otpSentTitle: 'Verification codes sent',
      otpSentBodyPhone: 'A verification code has been sent to your mobile number.',
      otpSentBodyBoth: 'Verification codes have been sent to your mobile number and email.',
      otpResentTitle: 'Verification code sent again',
      ...
      errors: {
        ...
        phoneRequired: 'Please link and verify your mobile number before deleting your account.',
        missingPhoneOtp: 'Please enter the mobile OTP.',
        missingEmailOtp: 'Please enter the email OTP.',
