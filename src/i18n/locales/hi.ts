...
export const hi = {
  ...
  entryForm: {
    ...
    waterLevelSyncFailed: 'लॉग सहेज लिए गए, लेकिन खेत का पानी स्तर अपडेट नहीं हो सका।',
    postSaveFollowUpFailed: 'लॉग सहेज लिए गए, लेकिन कुछ बाद की अपडेट पूरी नहीं हो सकीं।',
