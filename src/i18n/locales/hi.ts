...
export const hi = {
  ...
  settings: {
    ...
    deleteAccountModal: {
      ...
      phoneOtpHint: 'हम आपके सत्यापित मोबाइल नंबर पर OTP भेजेंगे: {{phone}}',
      phoneOtp: {
        label: 'मोबाइल OTP',
        placeholder: '6 अंकों का कोड दर्ज करें',
        resend: 'मोबाइल OTP पुनः भेजें',
      },
      emailOtp: {
        label: 'ईमेल OTP',
        placeholder: '6 अंकों का कोड दर्ज करें',
        resend: 'ईमेल OTP पुनः भेजें',
      },
      checkbox: {
      ...
      otpSentTitle: 'सत्यापन कोड भेज दिए गए',
      otpSentBodyPhone: 'सत्यापन कोड आपके मोबाइल नंबर पर भेज दिया गया है।',
      otpSentBodyBoth: 'सत्यापन कोड आपके मोबाइल नंबर और ईमेल पर भेज दिए गए हैं।',
      otpResentTitle: 'सत्यापन कोड फिर से भेजा गया',
      ...
      errors: {
        ...
        phoneRequired: 'खाता हटाने से पहले कृपया अपना मोबाइल नंबर लिंक और सत्यापित करें।',
        missingPhoneOtp: 'कृपया मोबाइल OTP दर्ज करें।',
        missingEmailOtp: 'कृपया ईमेल OTP दर्ज करें।',
