...
export const hi = {
  ...
  guidedTour: {
    welcome: {
      title: 'Vinesight में आपका स्वागत है',
      body: 'आइए एक मिनट में आपका पहला फार्म सेट करें।',
      setupTime: '1 मिनट सेटअप',
    },
    step1: {
      coach: 'अपना पहला फार्म जोड़ने के लिए यहां टैप करें।',
      formNameCoach: 'पहले अपने फार्म का नाम दर्ज करें।',
      formRegionCoach: 'अपने फार्म का स्थान (क्षेत्र) जोड़ें।',
      formAreaCoach: 'अब अपने फार्म का क्षेत्रफल एकड़ में दर्ज करें।',
      ...
      formSubmitCoach: 'बहुत अच्छा। जारी रखने के लिए फार्म बनाएं टैप करें।',
    },
    step2: {
      coach: 'बहुत बढ़िया! अब अपनी पहली ऑब्ज़र्वेशन लॉग करें।',
      addEntryCoach: '{{activity}} विवरण भरें, फिर एंट्री जोड़ें टैप करें।',
      startSeasonCoach:
        'पहले सीज़न शुरू करें ताकि Vinesight आपकी रिकॉर्ड्स को सही तरह से व्यवस्थित कर सके।',
      startSeasonHelper: 'ज़रूरत हो तो टेम्पलेट/तारीख बदलें, फिर स्टार्ट सीज़न पर टैप करें।',
      pickActivityCoach:
        'इस हफ्ते आपने अपने फार्म पर एक कौन-सा काम किया? रिकॉर्ड करने के लिए एक गतिविधि चुनें।',
      pickActivityHelper:
        'अगर वह आज का नहीं है तो भी ठीक है। जो याद हो उसे लॉग करें (सिंचाई, फर्टिगेशन, स्प्रेइंग, खर्च)।',
    },
    complete: {
      title: 'आप पूरी तरह तैयार हैं!',
      body: 'Vinesight आपका फार्म डेटा सुरक्षित रखेगा और इनसाइट्स बढ़ाएगा।',
    },
    reminderPush: {
      title: 'आपका फार्म आपका इंतज़ार कर रहा है!',
