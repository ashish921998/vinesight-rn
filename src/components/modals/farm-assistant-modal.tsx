...
import { View, Text, Pressable, TextInput, ScrollView, InteractionManager } from 'react-native';
      ...
      case 'listening':
        return (
          <View style={{ alignItems: 'center', paddingVertical: spacing[6], gap: spacing[3] }}>
            ...
            >
              <SymbolIcon name="lightbulb.fill" size={28} color={m3.colorScheme.onPrimary} />
            </Pressable>
